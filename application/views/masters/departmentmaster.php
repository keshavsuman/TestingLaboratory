...
<div class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-tooltip">Department Master</h4>
  ...
  <div class="card-body collapse in">
    <div class="card-block">
      ...
      <form class="form" method="POST" action="<?php echo base_url('master/department_add');?>">
        <div class="form-body">
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                <label for="issueinput1">Department</label>
                <input type="text" id="issueinput1" class="form-control" placeholder="Enter Department" name="department" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Enter Department">
              </div>
            </div>
          </div>
          <div>
          ...
          <tbody>
            ...
            ?>
              <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-outline-danger" value="<?php echo $d->department_id;?>" onclick="delet(this.value)" data-toggle="modal" data-target="#deleteModal">
                      <i class="icon-bin"></i>
                    </button>
                  </td>
              </tr>
      ...
      <div class="modal fade text-xs-left" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <form class="form" action="<?php echo base_url('master/update_department'); ?>" method="post">
            <div class="col-lg-6">
              <div class="form-group">
                <label for="issueinput1">Department</label>
      ...
      <div class="modal fade text-xs-left" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
          <h5>Are You Sure ?</h5>
          <p>This action will remove entry from Department Master.</p>
          </div>
          <div class="modal-footer">
          <form action="<?php echo base_url('master/department_delete');?>" method="post">
            <input type="hidden" name="department_id" id="delete" value="">
