...
<div class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-tooltip">Rate Card Master</h4>
        ...
        <div class="form-body">
          <div class="row">
            <div class="col-lg-4">
              ...
              <select id="issueinput7" name="subtest" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Department">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label for="issueinput1">Sample Machining Rate</label>
                <input type="number" id="issueinput1" class="form-control" placeholder="Sample Machining Rate" name="machiningrate" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=:"Sample Machining Rate ">
              </div>
            </div>
          </div>
          <div>
