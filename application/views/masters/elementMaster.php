...
<div class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-tooltip">Element Master</h4>
  ...
  <div class="card-body collapse in">
    <div class="card-block">
      ...
      <form class="form" method="POST" action="<?php echo base_url('master/add_elementMaster');?>">
        <div class="form-body">
          <div class="row">
            <div class="col-lg-4">
              <div class="form-group">
              <label for="issueinput7">Element Type :</label>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="issueinput1" class="form-control" placeholder="Enter Element Name" name="elementname" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Element Name">
              </div>
            </div>
          </div>
          <div>
          ...
          <tbody>
            ...
            ?>
              <tr>
                  ...
                  <td><?php echo $e->element_type;?></td>
                  <td id="edit<?php echo $e->element_id;?>"><?php echo $e->element_name;?></td>
                  <td><?php ?></td>
                  <td>
