...
<div class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-tooltip">Observation Master</h4>
  ...
  <div class="card-body collapse in">
    <div class="card-block">
      ...
      <form class="form" method="POST" action="<?php echo base_url('master/add_observationMaster');?>">
        <div class="form-body">
          <div class="row">
            <div class="col-lg-4">
              <div class="form-group">
              <label for="issueinput7">Test Form</label>
              <select id="issueinput7" name="testform" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Test Form">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label for="issueinput1">Observation</label>
                <input type="text" id="issueinput1" class="form-control" placeholder="Enter Observation" name="observation" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Enter Observation">
              </div>
            </div>
          </div>
          <div>
      ...
      <div class="modal fade text-xs-left" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <form class="form" action="<?php echo base_url('master/update_observationMaster'); ?>" method="post">
            <div class="col-lg-6">
              <div class="form-group">
      ...
      <div class="modal fade text-xs-left" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
          <h5>Are You Sure ?</h5>
          <p>This action will remove entry from Observation Master.</p>
          </div>
          <div class="modal-footer">
          <form action="<?php echo base_url('master/delete_observationMaster');?>" method="post">
            <input type="hidden" name="observation_id" id="delete" value="">
