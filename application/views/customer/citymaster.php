...
<div class="card">
  <div class="card-header">
    <h4 class="card-title" id="basic-layout-tooltip">City Master</h4>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="issueinput1" class="form-control" placeholder="Enter City" name="city" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Enter City">
              </div>
            </div>
          </div>
          <div>
          ...
          <tbody>
            ...
            ?>
              <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-outline-danger" value="<?php echo $c->city_id;?>" onclick="delet(this.value)" data-toggle="modal" data-target="#deleteModal">
                      <i class="icon-bin"></i>
                    </button>
                  </td>
              </tr>
